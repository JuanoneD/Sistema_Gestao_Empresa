...
//Função para retornar um pedido pelo index
...
//Função que realiza a pesquisa por id no array de pedidos
...
//Função que chama o arquivo tsv de pedidos
...
//Função que altera o arquivo tsv de pedidos
void set_tsv_pedido(Array_pedidos *array, char arquivo[])
{
    organizar_array_pedido(array);
...
//Free do array de pedidos
void destruir_array_pedidos(Array_pedidos *array)
{
    free(array->array);
    free(array);
}
